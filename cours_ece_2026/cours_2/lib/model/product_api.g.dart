...
ProductAPIResponseEntity _$ProductAPIResponseEntityFromJson(
  ...
  (json['countries_tags'] as List<dynamic>?)?.map((e) => e as String).toList(),
  json['nutriscore_grade'] as String?,
  (json['nova_group'] as num?)?.toInt(),
  (json['ecoScore'] as num?)?.toInt(),
  json['ecoscore_grade'] as String?,
...
Map<String, dynamic> _$ProductAPIResponseEntityToJson(
  ...
  'countries_tags': instance.manufacturingCountries,
  'nutriscore_grade': instance.nutriScore,
  'nova_group': instance.novaScore,
